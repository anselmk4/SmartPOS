...
function BillingPageContent() {
  ...
  // Open modal if redirected with plan parameter
  useEffect(() => {
  ...
  const plans = [
    {
      ...
      badge: "Pour démarrer",
      features: [
        "1 Caisse tactile locale (100% Hors-ligne)",
        "100 ventes par mois",
        "Carnet de dettes (max 10 clients)",
        "Export comptable Excel (CSV) & PDF",
        "Factures en attente & Additions",
    ...
    },
    {
      ...
      features: [
        ...
        "Export des rapports comptables complets",
      ],
    ...
    },
    {
      ...
      features: [
        ...
        "Sauvegarde Cloud continue & Ticket Z avancé",
      ],
  ...
  const comparisonFeatures = [
    ...
    { title: "Export comptable Excel (CSV) & PDF", free: true, basic: true, pro: true, biz: true },
    ...
    { title: "Gestion des Congés & Absences Personnel", free: false, basic: false, pro: false, biz: true },
