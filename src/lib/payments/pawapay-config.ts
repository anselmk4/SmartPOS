    ...
    operators: [
      {
        ...
        correspondent: "ORANGE_MLI",
        color: "#FF7900",
        bgLight: "bg-orange-50 border-orange-200 text-orange-700",
        textColor: "text-orange-600",
        iconName: "Orange",
        samplePrefix: "70, 71, 72",
      },
      {
        id: "MOOV_MONEY",
        name: "Moov Money Mali (Malitel)",
        correspondent: "MOOV_MLI",
        color: "#005BA6",
        bgLight: "bg-blue-50 border-blue-200 text-blue-700",
        textColor: "text-blue-600",
        iconName: "Moov",
    ...
    operators: [
      {
        ...
        textColor: "text-orange-600",
        iconName: "Orange",
        samplePrefix: "07, 06, 05",
      },
      {
        id: "MOOV_MONEY",
        name: "Moov Money Burkina",
