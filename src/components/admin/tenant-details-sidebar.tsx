  ...
  return (
    <div className="fixed inset-0 z-50 overflow-hidden animate-in fade-in duration-200">
      ...
      />
        ...
        {/* Drawer Panel */}
        <div className="fixed inset-y-0 right-0 max-w-xl w-full bg-white dark:bg-slate-900 border-l border-slate-200 dark:border-slate-800 shadow-2xl flex flex-col transform transition-transform duration-300 ease-out z-50">
          {/* Top Header */}
          <div className="p-5 sm:p-6 border-b border-slate-100 dark:border-slate-800/80 bg-slate-50/50 dark:bg-slate-900/90 flex items-start justify-between gap-4">
            <div className="flex items-start gap-3.5 min-w-0">
              <div
                className={`w-12 h-12 rounded-2xl flex items-center justify-center font-black text-xl text-white shadow-md shrink-0 ${
              ...
              <div className="min-w-0 flex-1">
                <div className="flex items-center gap-2 flex-wrap">
                  ...
                  <span
                    className={`px-2.5 py-0.5 rounded-full text-[10px] font-black uppercase tracking-wider ${
                      tenant.plan === "BUSINESS"
                        ? "bg-purple-50 text-purple-700 border border-purple-200 dark:bg-indigo-500/20 dark:text-indigo-300 dark:border-indigo-500/30"
                        : tenant.plan === "PRO"
                ...
                <div className="flex items-center gap-1.5 mt-1 text-slate-500 dark:text-slate-400 text-xs font-mono">
                  ...
                  <button
                    ...
                    className="text-slate-400 hover:text-blue-600 dark:hover:text-white p-1 rounded transition-colors"
            ...
            <button
              onClick={onClose}
              className="w-8 h-8 rounded-full bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-500 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white flex items-center justify-center transition-colors shrink-0"
            >
              <X className="w-4 h-4" />
            </button>
          </div>
